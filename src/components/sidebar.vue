<template>
  ...
  <aside
    class="bg-[#1a2332] h-screen flex flex-col justify-between py-6 text-gray-400 z-40 transition-all border-r border-gray-800 shadow-2xl shrink-0"
    :class="[
      showSidebar 
        ? 'fixed left-0 w-72' 
  ...
  >
    ...
    <div class="flex flex-col flex-1 min-h-0">
      ...
      <nav class="space-y-1 px-3 overflow-y-auto custom-scrollbar flex-1">
        ...
        <div>
          ...
          <!-- Subopciones Desplegables con Desplazamiento Suave -->
          <div 
    ...
    <!-- Área Inferior (Fija en la parte inferior) -->
    <div class="px-4 pt-4 shrink-0 border-t border-gray-800/60 mt-2">
